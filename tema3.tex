...
\label{sec:orgc020bd3}

\begin{frame}[label={sec:orgb07b9e0}]{¿Por qué?}
\begin{itemize}
...
\begin{frame}[label={sec:org4c62e26}]{Paralelismo ideal}
\begin{itemize}
...
\begin{frame}[label={sec:orga2ef627}]{Tiempo de ejecución}
\begin{itemize}
...
\begin{frame}[label={sec:orgf186aa1}]{Overhead del paralelismo}
\begin{itemize}
...
\begin{frame}[label={sec:orgd9f2f8c}]{Speedup}
\begin{itemize}
...
\begin{frame}[label={sec:org61b4ee1}]{Eficiencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgaeeab75}]{Escalabilidad}
\begin{itemize}
...
\begin{frame}[label={sec:org40f8fca}]{Ley de Amdahl}
\begin{itemize}
...
\begin{frame}[label={sec:org0e79108}]{Ley de Amdahl}
\begin{itemize}
...
\begin{frame}[label={sec:orge80ffab}]{Ley de Gustafson}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8cee22}]{¿Cómo tomar medidas?}
\begin{itemize}
...
\begin{frame}[label={sec:org5d389c1},fragile]{Medir tiempo en Julia}
 \begin{itemize}
