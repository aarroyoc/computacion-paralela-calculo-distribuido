...
\label{sec:orgc53a95c}

\begin{frame}[label={sec:org518c2d9}]{Julia}
\begin{center}
...
\begin{frame}[label={sec:orgb4a3bb7}]{Descargar Julia}
\url{https://julialang.org/}
\end{frame}

\begin{frame}[label={sec:orgffafce7},fragile]{Ejecutar programas}
...
\begin{frame}[label={sec:org2e5be27},fragile]{Variables}
 \begin{itemize}
...
\begin{frame}[label={sec:org9ce0e76},fragile]{Vectores y matrices}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf4dcca7},fragile]{Vectores y matrices}
 \begin{verbatim}
a = zeros(2,2)
a[1,1] = 5
a[1,2] = 6
...
\begin{frame}[label={sec:org704e48e},fragile]{Vectores y matrices}
 \begin{verbatim}
...
\begin{frame}[label={sec:orgc40d623},fragile]{Estructuras de control}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb883709},fragile]{Estructuras de control}
 \begin{verbatim}
a = [1, 2, 3]
suma = 0
n = 1
...
\begin{frame}[label={sec:orgac10c3e},fragile]{Estructuras de control}
 \begin{verbatim}
a = [1, 2, 3]
suma = 0
for i in a
...
\begin{frame}[label={sec:org332de34},fragile]{List comprehensions y rangos}
 \begin{itemize}
...
\begin{frame}[label={sec:org6373764},fragile]{Funciones}
 \begin{itemize}
...
\begin{frame}[label={sec:org0fa03a4},fragile]{Vectorización}
 \begin{itemize}
...
\begin{frame}[label={sec:org37b9bd7},fragile]{Extra}
 \begin{itemize}
