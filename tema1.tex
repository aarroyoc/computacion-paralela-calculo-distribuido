...
\label{sec:org60931df}

\begin{frame}[label={sec:org5cd42c5}]{Contenidos de la asignatura}
\begin{itemize}
\item Introducción
\begin{itemize}
...
\begin{frame}[label={sec:org73bdc8c}]{Evaluación}
...
\begin{frame}[label={sec:orgf03cbab}]{Evaluación II}
...
\begin{frame}[label={sec:orgfb39cc6}]{Motivación}
¿Por qué es importante la computación paralela y el cálculo distribuido?
\end{frame}

\begin{frame}[label={sec:org35101be}]{Motivación II}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2fe755}]{Motivación III}
\begin{center}
\includegraphics[width=.9\linewidth]{./VUP.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga4000aa}]{Motivación IV}
...
\begin{frame}[label={sec:org926bfea}]{Muro de Potencia}
\begin{center}
\includegraphics[width=.9\linewidth]{./MuroPotencia.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgcb5f635}]{Muro de Potencia II}
\begin{itemize}
...
\begin{frame}[label={sec:org1253c3f}]{Soluciones}
...
\begin{frame}[label={sec:orgf45157b}]{¿El santo grial?}
...
\begin{frame}[label={sec:org9de4e7b}]{Julia}
\begin{center}
...
\begin{frame}[label={sec:org39ecd3a}]{Descargar Julia}
\url{https://julialang.org/}
\end{frame}

\begin{frame}[label={sec:orgce2dcc4}]{Conociendo el ordenador}
\begin{center}
...
\begin{frame}[label={sec:org627712f}]{MareNostrum}
...
\begin{frame}[label={sec:org9d6548e}]{Detalles MareNostrum 5}
\begin{itemize}
...
\begin{frame}[label={sec:orgeff5b9d}]{Benchmarks}
\begin{itemize}
...
\begin{frame}[label={sec:orgb876c40}]{Linpack}
\begin{center}
\includegraphics[width=0.9\textwidth]{./Linpack1.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org717b820}]{Linpack 2}
\begin{center}
\includegraphics[width=0.7\textwidth]{./Linpack2.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org062f8b1}]{Comparativa}
\begin{block}{FLOPS}
...
\begin{frame}[label={sec:orgac966c1}]{Final}
\begin{itemize}
